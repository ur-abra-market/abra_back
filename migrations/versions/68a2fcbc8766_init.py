...
Revision ID: 68a2fcbc8766
Revises: 
Create Date: 2023-02-13 13:01:39.436010
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=30), nullable=False),
    sa.Column('property_display_type_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['property_display_type_id'], ['property_display_types.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('license_number', sa.String(length=25), nullable=True),
    ...
    op.create_table('user_payment_creds',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('card_holder', sa.String(length=30), nullable=False),
    sa.Column('card_number', sa.String(length=30), nullable=False),
    sa.Column('expired_date', sa.String(length=10), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('user_payment_creds')
