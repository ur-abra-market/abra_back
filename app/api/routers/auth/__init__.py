...
router.include_router(signout_router, tags=[f'{emoji} [auth] - sign-out (logout)'], prefix="/sign-out")
router.include_router(signup_router, tags=[f'{emoji} [auth] - sign-up (register)'], prefix="/sign-up")
