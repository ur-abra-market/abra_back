...
class BundleVariationPodModel(mixins.ProductIDMixin, ORMModel):
    bundle_variations: Mapped[List[BundleProductVariationValueModel]] = relationship(back_populates="pod")
    ...
    prices: Mapped[Optional[List[BundleVariationPodPriceModel]]] = relationship(back_populates="bundle_variation_pod")