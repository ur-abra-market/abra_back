...
from app.settings import ALLOW_ORIGINS, DEBUG, DOCS_URL, OPENAPI_URL, REDOC_URL
...
def startup():
    ...
    logging.getLogger("sqlalchemy.engine").setLevel(logging.DEBUG if DEBUG else logging.ERROR)
    logging.getLogger("sqlalchemy.pool").setLevel(logging.ERROR if DEBUG else logging.ERROR)
